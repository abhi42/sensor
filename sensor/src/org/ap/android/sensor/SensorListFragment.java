...
/**
 * A list fragment representing a list of Sensors. This fragment also supports tablet devices by allowing list items to
...
public class SensorListFragment extends ListFragment {
	...
	private List<SensorDTO> displayableSensorList;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		displayableSensorList = sensorContentProvider.getAvailableSensors();

		// setListAdapter(new ArrayAdapter<DummyContent.DummyItem>(getActivity(),
		// android.R.layout.simple_list_item_activated_1, android.R.id.text1, DummyContent.ITEMS));
		setListAdapter(new ArrayAdapter<SensorDTO>(getActivity(), android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, displayableSensorList));
	}
...
//		SensorDTO sensorDTO = displayableSensorList.get(position);
